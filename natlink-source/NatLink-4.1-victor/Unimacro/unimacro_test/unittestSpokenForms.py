...
expected_char2spoken =   {u'a': ['Alpha'],
                            u'b': ['Bravo'],
                            u'c': ['Charlie'],
                            u'd': ['Delta'],
                            u'e': ['Echo']}
...
class UnittestNumbersSpokenForms(TestCaseWithHelpers.TestCaseWithHelpers):
    ...
    def test_get_number_back_from_spoken_form(self):
        ...
        n = self.numbers
        expected = 1
        self.assert_equal(expected, n.getNumberFromSpoken('on\xe9'), "numbers: get number back from spoken form not as expected")
        ...
        self.assert_equal(expected, n.getNumberFromSpoken('four', originalList), "numbers: get number back from spoken form not as expected (with originalList)")
        expected = 1
        self.assert_equal(expected, n.getNumberFromSpoken('on\xe9', originalList), "numbers: get number back from spoken form not as expected (with originalList)")
        expected = 1
    ...
    def test_get_number_back_from_spoken_form_asStr(self):
        ...
        n = self.numbers
        expected = '1'
        self.assert_equal(expected, n.getNumberFromSpoken('on\xe9', asStr=True), "numbers: get number back as str from spoken form not as expected")
        ...
        self.assert_equal(expected, n.getNumberFromSpoken('four', originalList, asStr=True), "numbers: get number back as str from spoken form not as expected (with originalList)")
        expected = '1'
        self.assert_equal(expected, n.getNumberFromSpoken('on\xe9', originalList, asStr=True), "numbers: get number back as str from spoken form not as expected (with originalList)")
        expected = '1'
